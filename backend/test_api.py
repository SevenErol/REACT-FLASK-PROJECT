...
class APITestCase(unittest.TestCase):
    ...
    def test_create_category(self):
        ...
        access_token = login_response.json["access_token"]
        create_category_response = self.client.post('/category/categories',
            json = {
	                "name": "Testname"
            },
            headers = {"Authorization": f"Bearer {access_token}"}
    ...
    def test_update_category(self):
        ...
        id = 1
        update_response = self.client.put(f'/category/category/{id}',
            json = {
                "name": "Testname3"
                },
            headers = {"Authorization": f"Bearer {access_token}"}                     
    ...
    def test_delete_categories(self):
        ...
        access_token = login_response.json["access_token"]
        create_product_response = self.client.post('/category/categories',
            json = {
	                "name": "Testname"
            },
            headers = {"Authorization": f"Bearer {access_token}"}
        ...
        id = 1
        delete_response = self.client.delete(f'/category/category/{id}', headers = {"Authorization": f"Bearer {access_token}"})
        status_code = delete_response.status_code
        self.assertEqual(status_code, 200)
